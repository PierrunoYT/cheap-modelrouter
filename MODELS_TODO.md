...
|---|---|---|
| ~~inclusionAI~~ | `inclusionai/ling-2.6-flash`, `inclusionai/ring-2.6-1t`, `inclusionai/ling-2.6-1t` | ADDED 2026-07-01/02 (full family). `ling-2.6-1t` added at user request as fallback depth (AA est. 26, no strengths). |
